...
- cpu.py
  ...
  - is cpu class where we load our program into memory and can run them
  - [] have to implement constructor
  - [] RAM functionality
  - [] implement core of run() method
  - [] implement HLT instruction handler
  - [] Add LDI instruction (sets specified register to value)
  - [] Add PRN instruction (prints the specified value at register)

- ls8.py
  - [] loads the cpu class and runs it
